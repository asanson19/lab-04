...
def on_connect(client, userdata, flags, rc):
   ...
   client.subscribe("asanson/ipinfo")
   client.subscribe("asanson/date")
   client.subscribe("asanson/time")
  
   #Add the custom callbacks by indicating the topic and the name of the callback handle
   client.message_callback_add("asanson/ipinfo", on_message_from_ipinfo)
   client.message_callback_add("asanson/date", on_message_from_date)
   client.message_callback_add("asanson/time", on_message_from_time)
