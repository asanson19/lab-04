...
if __name__ == '__main__':
   ...
   while True:
       ...
       client.publish("asanson/ipinfo", f"{ip_address}")
       ...
       client.publish("asanson/ipinfo/date", f”{date}”)
       print("Publishing date: " + date)
       ...
       client.publish("asanson/ipinfo/time", f”{time}”)
